...
)
{
    ...
    _NtAllocateVirtualMemory NtAllocateVirtualMemory = (_NtAllocateVirtualMemory)GetFunctionAddress(IsModulePresent(L"ntdll.dll"), "NtAllocateVirtualMemory");
...
)
{
    ...
    _NtProtectVirtualMemory NtProtectVirtualMemory = (_NtProtectVirtualMemory)GetFunctionAddress(IsModulePresent(L"ntdll.dll"), "NtProtectVirtualMemory");
    DWORD dwProtect;
    PIMAGE_NT_HEADERS pNtHeaders;
